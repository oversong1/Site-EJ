...
<?php $wppFloat = $settings->get('contact_whatsapp', '5511999999999'); $wppFloatUrl = 'https://wa.me/' . preg_replace('/\D/', '', $wppFloat); ?>
<a href="<?php echo e($wppFloatUrl); ?>" class="wpp-float" target="_blank" aria-label="WhatsApp">
